...
export class ProductListComponent {
  ...
  totalProductAvailable: number = this.products.length;
  productsInStock: number = this.products.filter(p => p.is_in_inventory).length;
  productsOutOfStock: number = this.products.filter(p => !p.is_in_inventory).length;
